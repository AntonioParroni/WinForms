...
namespace WindowsFormsDz_2_3
{
    public partial class Form1 : Form
    {
        ...
        readonly double[] GasArray = { 2.75, 2.87, 3.03, 2.71, 1.84 };
        ...
        private void FormLoad(object sender, EventArgs e)
        {
            ...
            textBoxFuelPrice.Text = $"{GasArray[0]}"; 
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (PayTotal == 0)
            {
                MessageBox.Show($"No Sales!", "Closing", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show($"Total Sales On {DateTime.Now.ToShortDateString()} = {Math.Round(PayTotal, 2)} $.", "Closing", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            if (tempTimer == 10)
            {
                DialogResult result = MessageBox.Show("Finish To Work With The Current Client ?", "Clear Form ?", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (result == DialogResult.Yes)
                {
                    PayTotal += PayGasStation + PayCafe;
                    timer.Stop();
                    Text = $"Total Sales On {DateTime.Now.ToShortDateString()} = {Math.Round(PayTotal, 2)} $.";
        ...
        private void ToCount_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No Operations", "Error!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        private void ComboBoxFuel_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                textBoxFuelPrice.Text = $"{GasArray[1]}";
            }
            if (radio.SelectedIndex == 2)
            {
                textBoxFuelPrice.Text = $"{GasArray[2]}";
            }
            if (radio.SelectedIndex == 3)
            {
                textBoxFuelPrice.Text = $"{GasArray[4]}";
            }
            if (radio.SelectedIndex == 4)
            {
                textBoxFuelPrice.Text = $"{GasArray[3]}";
            }
            textBoxRadioCount.Text = "0,00";
